...
class Examens {
    ...
    static create(a, b, c, d, e, f, g, h, i, j, k, observateurId) {
        return new Promise((resolve, reject) => {
            axios.post(`${VUE_APP_API_BASE_URL}/appareil_levage-famille2_lev2/examens/create`,
                {
    ...
    static select(observateurId) {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`${VUE_APP_API_BASE_URL}/appareil_levage-famille2_lev2/examens/${observateurId}`,
                {
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    static reset(observateurId) {
        ...
        return new Promise((resolve, reject) => {
            axios.delete(`${VUE_APP_API_BASE_URL}/appareil_levage-famille2_lev2/examens/${observateurId}`,
                {
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    static updateStatus(observateurId, titreReserve) {
        ...
        return new Promise((resolve, reject) => {
            axios.post(`${VUE_APP_API_BASE_URL}/appareil_levage-famille2_lev2/examens/updateStatus`,
                {
    ...
    static changeStatusCritique(titre, statusCritique, observateurId) {
        ...
        return new Promise((resolve, reject) => {
            axios.post(`${VUE_APP_API_BASE_URL}/appareil_levage-famille2_lev2/examens/changeStatusCritique`,
                {
                    titre: titre,
