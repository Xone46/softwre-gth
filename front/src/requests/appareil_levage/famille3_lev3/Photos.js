...
class Photos {
    ...
    static create(file, observateurId) {
        return new Promise((resolve, reject) => {
            ...
            axios.post(`${VUE_APP_API_BASE_URL}/appareil_levage-famille3_lev3/photos/create`, formData, {
                headers: {
    ...
    static select(observateurId) {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`${VUE_APP_API_BASE_URL}/appareil_levage-famille3_lev3/photos/${observateurId}`,
            {
                headers: {
    ...
    static reset(observateurId) {
        ...
        return new Promise((resolve, reject) => {
            axios.delete(`${VUE_APP_API_BASE_URL}/appareil_levage-famille3_lev3/photos/${observateurId}`,
            {
                headers: {
                     'Content-Type': 'application/json'
                 }
    ...
    static displayImage(filename) {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`${VUE_APP_API_BASE_URL}/appareil_levage-famille3_lev3/photos/display/${filename}`, {
