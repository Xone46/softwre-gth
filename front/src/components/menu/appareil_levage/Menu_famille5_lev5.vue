    ...
    <div class="menu">
        <table>
            <tr>
                ...
                <th class="green" v-if="colorRenseignement_famille5_lev5" @click="renseignement">
                    <div>
                ...
                <th v-if="!colorRenseignement_famille5_lev5" @click="renseignement">
                    <div>
                ...
                <th class="green" v-if="colorDescription_famille5_lev5" @click="description">
                    <div>
                        <img src="@/assets/mark.png" alt="pencil">
                        <span>DESCRIPTION DE L'APPAREIL VERIFIE</span>
                    </div>
                </th>
                <th v-if="!colorDescription_famille5_lev5" @click="description">
                    <div>
                        <img src="@/assets/pencil.png" alt="pencil">
                        <span>DESCRIPTION DE L'APPAREIL VERIFIE</span>
                    </div>
                ...
                <th class="green" v-if="colorExamen_famille5_lev5" @click="examen">
                    <div>
                        <img src="@/assets/mark.png" alt="pencil">
                        <span>EXAMEN ET ESSAIS DE L'APPAREIL</span>
                    </div>
                </th>
                <th v-if="!colorExamen_famille5_lev5" @click="examen">
                    <div>
                        <img src="@/assets/pencil.png" alt="pencil">
                        <span>EXAMEN ET ESSAIS DE L'APPAREIL</span>
                    </div>
                ...
                <th class="green" v-if="colorConclusion_famille5_lev5" @click="conclusion">
                    <div>
                        <img src="@/assets/mark.png" alt="pencil">
                        <span>CONCLUSION</span>
                    </div>
                </th>
                <th v-if="!colorConclusion_famille5_lev5" @click="conclusion">
                    <div>
                        <img src="@/assets/pencil.png" alt="pencil">
                        <span>CONCLUSION</span>
                    </div>
                ...
                <th class="green" v-if="colorPhoto_famille5_lev5" @click="photo">
                    <div>
                        <img src="@/assets/mark.png" alt="pencil">
                        <span>PHOTO</span>
                    </div>
                </th>
                <th v-if="!colorPhoto_famille5_lev5" @click="photo">
                    <div>
                        <img src="@/assets/pencil.png" alt="pencil">
                        <span>PHOTO</span>
                    </div>
...
// import Renseignements from "@/requests/appareil_levage/famille5_lev5/Renseignement";
...
// import Conclusions from "@/requests/appareil_levage/famille5_lev5/conclusion";
...
export default {
    ...
    props: {
        ...
        colorRenseignement_famille5_lev5 : Boolean,
        colorDescription_famille5_lev5 : Boolean,
        colorExamen_famille5_lev5 : Boolean,
        colorConclusion_famille5_lev5 : Boolean,
        colorPhoto_famille5_lev5 : Boolean
    },
