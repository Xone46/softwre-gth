    ...
    methods: {
        ...
        checkProperties() {
            ...
            for (let w = 0; w < k.length; w++) {
                ...
                const arr = [k[w].be, k[w].fc, k[w].nv, k[w].o, k[w].sa, k[w].so, k[w].statusCritique];
        ...
        notEmpty() {
            this.$emit("changeColorExamen_famille4_lev4", this.checkProperties());
        },
