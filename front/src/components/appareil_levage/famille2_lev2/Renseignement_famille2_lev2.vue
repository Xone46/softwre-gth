                ...
                <tr>
                    ...
                    <td>
                        <select @change="saisirTypeAppareil($event)" :value="renseignement.typeAppareil">
                            ...
                            <option value="Grues sur portiques">Grues sur portiques</option>
                            <!-- <option value="Monte-meubles destinés a la manutention de mobilier">Monte-meubles destinés a la manutention de mobilier</option> -->
                            <!-- <option value="Monte matériaux destinés exclusivement au transport de charges, destinés à être installés temporairement à poste fixe, conçus pour être déplacés ou démontés, comportant un équipage mobile qui se déplace le long de guides verticaux ou inclinés ;">Monte matériaux destinés exclusivement au transport de charges, destinés à être installés temporairement à poste fixe, conçus pour être déplacés ou démontés, comportant un équipage mobile qui se déplace le long de guides verticaux ou inclinés ;</option> -->
...
import Renseignement from "@/requests/appareil_levage/famille2_lev2/Renseignement"
import Completed from "@/requests/appareil_levage/famille2_lev2/completed";
